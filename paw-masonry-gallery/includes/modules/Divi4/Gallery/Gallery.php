...
class DMG_Gallery extends ET_Builder_Module
{
    protected $settings;

    public $icon_path;

    const MAIN_CSS_ELEMENT = '%%order_class%%.divi-masonry-gallery';

    protected $module_credits = [
        'module_uri' => 'https://diviextensions.com/divi-pro-gallery/',
    ...
    public function init()
    {
        ...
        $this->name             = esc_html__('Masonry Gallery', 'divi-masonry-gallery');
        ...
        $this->settings_modal_toggles = [
            'general'  => [
                'toggles' => [
                    'general'     => esc_html__('General', 'divi-masonry-gallery'),
                    'caption'     => esc_html__('Captions', 'divi-masonry-gallery'),
                    'lightbox'    => esc_html__('Lightbox', 'divi-masonry-gallery'),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    'overlay'     => esc_html__('Overlay', 'divi-masonry-gallery'),
                    'items'        => esc_html__('Items', 'divi-masonry-gallery'),
                    'image'        => esc_html__('Image', 'divi-masonry-gallery'),
                    'caption'      => esc_html__('Caption', 'divi-masonry-gallery'),
                    'caption_text' => [
                        'title'             => esc_html__('Caption Text', 'divi-masonry-gallery'),
                        'tabbed_subtoggles' => true,
                        'sub_toggles'       => [
                            'caption_title' => [
                                'name' => esc_html__('Title', 'divi-masonry-gallery'),
                            ],
                            'caption_desc'  => [
                                'name' => esc_html__('Description', 'divi-masonry-gallery'),
                            ],
                        ],
                    ],
                ],
        ...
        $this->custom_css_fields = [
            'gallery' => [
                'label'    => esc_html__('Gallery', 'divi-masonry-gallery'),
                'selector' => '.divi-masonry-gallery',
            ],

            'items'   => [
                'label'    => esc_html__('Items', 'divi-masonry-gallery'),
                'selector' => '.dmg-items',
            ],

            'item'    => [
                'label'    => esc_html__('Item', 'divi-masonry-gallery'),
                'selector' => '.dmg-item',
            ],

            'image'   => [
                'label'    => esc_html__('Image', 'divi-masonry-gallery'),
                'selector' => '.dmg-item .pic',
            ],
        ];
    }
    ...
    public function get_fields()
    {
        $general = [
            ...
            'gallery_ids'     => [
                'label'            => __('Choose Images', 'divi-masonry-gallery'),
                'description'      => __('Choose the images that you would like to appear in the image gallery.', 'divi-masonry-gallery'),
                'type'             => 'upload-gallery',
            ...
            'image_size'      => [
                'label'            => __('Image Size', 'divi-masonry-gallery'),
                'type'             => 'select',
                'description'      => __(' Select the size of your images.', 'divi-masonry-gallery'),
                'default'          => 'medium',
            ...
            '_layout'         => [
                'type'        => 'dmg_separator',
                '_text'       => __('Gallery Layout', 'divi-masonry-gallery'),
                'toggle_slug' => 'general',
            ],

            'gallery_type'    => [
                'label'            => __('Gallery Type', 'divi-masonry-gallery'),
                'type'             => 'dmg_layout_selector',
                'default'          => 'masonry',
                'options'          => [
                    'masonry'   => __('Masonry', 'divi-masonry-gallery'),
                    'grid'      => __('Grid', 'divi-masonry-gallery'),
                    'highlight' => __('Highlight', 'divi-masonry-gallery'),
                    'slider'    => __('Slider', 'divi-masonry-gallery'),
                ],
                'toggle_slug'      => 'general',
                'computed_affects' => [
                    '__gallery',
            ...
            'columns'         => [
                'label'            => __('Columns', 'divi-masonry-gallery'),
                'toggle_slug'      => 'general',
                'type'             => 'select',
                'default'          => '4',
                'options'          => [
            ...
            'gutter'          => [
                'label'            => __('Spacing', 'divi-masonry-gallery'),
                'toggle_slug'      => 'general',
                'type'             => 'text',
                'option_category'  => 'basic_option',
                'default'          => 20,
        ...
        $overlay = [
            'overlay_bg_color' => [
                'label'          => esc_html__('Overlay Color', 'divi-masonry-gallery'),
                'type'           => 'color-alpha',
                'default'        => '',
                'custom_color'   => true,
                'mobile_options' => true,
            ...
            'overlay_bg_opacity' => [
                'label'            => esc_html__('Opacity', 'divi-masonry-gallery'),
                'type'             => 'range',
        ...
        $click_action = [
            ...
            'click_action'     => [
                'label'            => __('Lightbox & Links', 'divi-masonry-gallery'),
                'type'             => 'select',
                'default'          => 'lightbox',
                'options'          => [
                    'no-link'    => esc_html__('No Link', 'divi-masonry-gallery'),
                    'file'       => esc_html__('Media File', 'divi-masonry-gallery'),
                    'attachment' => esc_html__('Attachment Page', 'divi-masonry-gallery'),
                    'lightbox'   => esc_html__('Lightbox', 'divi-masonry-gallery'),
                ],
                'option_category'  => 'basic_option',
        ...
        $caption = [
            'hide_caption'     => [
                'label'            => esc_html__('Hide Caption', 'divi-masonry-gallery'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('yes', 'divi-masonry-gallery'),
                    'off' => __('no', 'divi-masonry-gallery'),
                ],
                'default'          => 'off',
                'toggle_slug'      => 'caption',
                'computed_affects' => [
            ...
            'hide_title'       => [
                'label'            => esc_html__('Hide Title', 'divi-masonry-gallery'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('yes', 'divi-masonry-gallery'),
                    'off' => __('no', 'divi-masonry-gallery'),
            ...
            'hide_description' => [
                'label'            => esc_html__('Hide Description', 'divi-masonry-gallery'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('yes', 'divi-masonry-gallery'),
                    'off' => __('no', 'divi-masonry-gallery'),
        ...
        $computed = [
            '__gallery' => [
                'type'                => 'computed',
                'computed_callback'   => ['DMG_Gallery', 'gallery_html'],
                'computed_depends_on' => [
                    'gallery_ids',
                    'image_size',
                    'columns',
    ...
    public function get_advanced_fields_config()
    {
        ...
        $advanced_fields['borders']['items'] = [
            'css'         => [
                'main' => [
                    'border_radii'  => '%%order_class%% .dmg-item',
                    'border_styles' => '%%order_class%% .dmg-item',
                ],
            ],
            'toggle_slug' => 'items',
        ];
        ...
        $advanced_fields['fonts']['caption_title'] = [
            ...
            'css'             => [
                'main' => "%%order_class%% .dmg-item-content h2",
            ],
            'font_size'       => [
                'default' => '18px',
            ],
        ...
        $advanced_fields['fonts']['caption_desc'] = [
            'label'           => esc_html__('Description', 'divi-masonry-gallery'),
            'css'             => [
                'main' => "%%order_class%% .dmg-item-content p",
            ],
            'font_size'       => [
                'default' => '14px',
            ],
        ...
        $advanced_fields['borders']['image'] = [
            'label_prefix' => esc_html__('Image', 'divi-masonry-gallery'),
            'css'          => [
                'main' => [
                    'border_radii'  => '%%order_class%% .dmg-items .dmg-item img, %%order_class%% .dmg-items .dmg-item .pic',
                    'border_styles' => '%%order_class%% .dmg-items .dmg-item img, %%order_class%% .dmg-items .dmg-item .pic',
                ],
            ],
            'tab_slug'     => 'advanced',
            'toggle_slug'  => 'image',
    ...
    public function gallery_handler($args = [], $conditional_tags = [], $current_page = [])
    {
        ...
        if (empty($this->props['gallery_ids'])) {
            return sprintf('%s', esc_html__('Gallery not found.', 'divi-masonry-gallery'));
        }
        ...
        foreach ($gallery_items as $image) {
            ...
            $image_data = [
                ...
                'item_classes'    => ['dmg-item'],
                'link_attributes' => [],
                'link_classes'    => ['dmg-item-link'],
            ...
            if ('no-link' !== $this->props['click_action']) {
                ...
                if ('lightbox' === $this->props['click_action']) {
                    $image_data['link_attributes']['href']       = $image_full ? esc_url($image_full[0]) : esc_url($image_src[0]);
                    $image_data['link_attributes']['class'][]    = 'dmg-lightbox-link';
                    $image_data['link_attributes']['aria-label'] = esc_html__('Open image', 'divi-masonry-gallery');
                    $image_data['link_attributes']['title']      = esc_html__('Open image', 'divi-masonry-gallery');

                    // Enable lightbox.
                    $image_data['link_attributes']['data-fancybox'] = 'dmg-gallery';
                }
            }

            include DMG_PLUGIN_DIR . 'includes/views/item.php';
        }
    ...
    public function render($attrs, $content, $render_slug)
    {
        ...
        wp_enqueue_script('dmg-frontend');
        wp_enqueue_style('dmg-frontend');
        ...
        $output = sprintf(
            '<div class="divi-masonry-gallery" %2$s>
                %1$s 
            </div>',
    ...
    public function generate_css($render_slug)
    {
        ...
        $this->generate_styles(
            [
                ...
                'selector'       => '%%order_class%% .dmg-item:hover .dmg-item-overlay',
        ...
        $this->generate_styles(
            [
                ...
                'selector'       => '%%order_class%% .dmg-item:hover .dmg-item-content img.pic',
    ...
    public static function _get_image_sizes()
    {
        ...
        $sizes['full'] = __('Full', 'divi-masonry-gallery');
